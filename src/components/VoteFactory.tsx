...
import { useAccount, usePrepareSendTransaction, useSendTransaction, useWaitForTransaction, useWalletClient } from 'wagmi';
    ...
    return (
        <form>
            ...
            <input
                ...
                value={lsdTokens}
            />
            <button disabled={!fip || !length || !twoYesOptions || !lsdTokens}>Send</button>
        </form>
    )
}
